...
var Quotes = []string{"Fear is the path to the dark side. Fear leads to anger. Anger leads to hate. Hate leads to suffering.",
	...
	"Hey, Doc? Doc. Hello, anybody home? Einstein, come here, boy. What's going on? Wha- aw, god. Aw, Jesus. Whoa, rock and roll. Yo",
	"Marty, is that you?",
	...
	"What's going on? Where have you been all week? Working.",
	...
	"Stop it. What? Does your mom know about tomorrow night?",
	...
	"Where were we. Right about here. Jennifer.",
	"It's my dad. Right. I've gotta go. I'll call you tonight. I'll be at my grandma's. Here, let me give you the number. Bye.",
	...
	"Hello, hello, anybody home? Think, McFly, think. I gotta have time to get them re-typed. Do you realize what would happen if I hand in my reports in your handwriting. I'll get fired. You wouldn't want that to happen would you? Would you?",
	...
	"What, what is it hot?",
	"It's cold, damn cold. Ha, ha, ha, Einstein, you little devil. Einstein's clock is exactly one minute behind mine, it's still ticking.",
	...
	"It's safe now. Everything's lead lined. Don't you lose those tapes now, we'll need a record. Wup, wup, I almost forgot my luggage. Who knows if they've got cotton underwear in the future. I'm allergic to all synthetics.",
	...
	"Indeed I will, roll em. I, Doctor Emmett Brown, am about to embark on an historic journey. What have I been thinking of, I almost forgot to bring some extra plutonium. How did I ever expect to get back, one pellet one trip I must be out of my mind.",
	"What is it Einy? Oh my god, they found me, I don't know how but they found me. Run for it, Marty.",
	"Who, who? Who do you think, the Libyans.",
	"Holy shit.",
	"Unroll their fire.",
	...
	"Alright, alright, okay McFly, get a grip on yourself. It's all a dream. Just a very intense dream. Woh, hey, listen, you gotta help me.",
	...
	"Brown, Brown, Brown, Brown, Brown, great, you're alive. Do you know where 1640 Riverside-",
	"Are you gonna order something, kid?",
	"Yeah, gimme a Tab. Tab? I can't give you a tab unless you order something.",
	...
	"Well yeah, you know we have two of them. Wow, you must be rich.",
	...
	"Yeah well, I saw it on a rerun. What's a rerun? You'll find out.",
	"You know Marty, you look so familiar, do I know your mother? Yeah, I think maybe you do.",
	...
	"Mother, with Marty's parents out of town, don't you think he oughta spend the night, after all, Dad almost killed him with the car.",
	...
	"Don't tell me anything. Doc, you gotta help-",
	...
	"So tell me, future boy, who's president of the United States in 1985? Ronald Reagon. Ronald Reagon, the actor? Then who's vice president, Jerry Lewis? I suppose Jane Wymann is the first lady. Whoa, wait, Doc. And Jack Benny is secretary of the Treasury.",
	...
	"Flux capacitor.",
	"It works, ha ha ha ha, it works. I finally invent something that works. Bet your ass it works.",
	...
	"whoa, whoa Doc, stuck here, I can't be stuck here, I got a life in 1985. I got a girl. Is she pretty?",
	...
	"A bolt of lightning, unfortunately, you never know when or where it's ever gonna strike. We do now.",
	...
	"I don't know, Doc, I guess she felt sorry for him cause her did hit him with the car, hit me with the car.",
	...
	"Good, there's somebody I'd like you to meet. Lorraine.",
	"Calvin.",
	"I'd like you to meet my good friend George McFly.",
	"Hi, it's really a pleasure to meet you.",
	"How's your head?",
	"Well uh, good, fine.",
	"Oh, I've been so worried about you ever since you ran off the other night. Are you okay? I'm sorry I have to go. Isn't he a dream boat?",
	...
	"George, buddy. remember that girl I introduced you to, Lorraine. What are you writing?",
	...
	"Uh no, not hard at all. So anyway, George, now Lorraine, she really likes you. She told me to tell you that she wants you to ask her to the Enchantment Under The Sea Dance.",
	"Oh yeah, all you gotta do is go over there and ask her.",
	"What, right here right now in the cafeteria? What if she said no? I don't know if I could take that kind of rejection. Besides, I think she'd rather go with somebody else.",
	...
	"You heard her she said get your meat hooks, off, her, please.",
	"So what's it to you, butthead. You know you've been looking for a, since you're new here, I'm gonna cut you a break, today. So why don't you make like a tree, and get out of here.",
	...
	"I over slept, look I need your help. I have to ask Lorraine out but I don't know how to do it. I have to ask Lorraine out but I don't know how to do it.",
	"Alright, okay listen, keep your pants on, she's over in the cafe. God, how do you do this? What made you change your mind, George?",
	...
	"Nothing, nothing, nothing, look tell her destiny has brought you together, tell her that she's the most beautiful you have ever seen. Girls like that stuff. What, what are you doing George?",
	"I'm writing this down, this is good stuff.",
	"Right. Lou, gimme a milk, chocolate.",
	"Lorraine, my density has popped me to you. What?",
	"Oh, what I meant to day was-. Hey, don't I know you from somewhere?",
	"Yes, yes, I'm George, George McFly, and I'm your density. I mean, I'm your destiny. Oh.",
	"Hey, McFly, I thought I told you never to come in here. Well it's gonna cost you. How much money you got on you? Well, Biff.",
	"Alright, punk, now-. Whoa, whoa, Biff, what's that?",
	...
	"I'm gonna ram him. Shiiiiiiit!",
	"Thanks a lot, kid.",
	"I'm gonna get that son-of-a-bitch.",
	"Where does he come from? Yeah, where does he live? I don't know, but I'm gonna find out.",
	...
	"You don't understand. I do understand. If I know too much about my own future I could endanger my own existence, just as you endangered yours.",
	...
	"Don't worry, I'll take care of the lightning, you take care of your pop. By the way, what happened today, did he ask her out? Uh, I think so.",
	"What did she say? It's your mom, she's tracked you down. Quick, let's cover the time machine.",
	"Hi, Marty.",
	"Uh, Lorraine. How did you know I was here? I followed you.",
	"Oh, uh, this is my Doc, Uncle, Brown.",
	"Marty, this may seem a little foreward, but I was wondering if you would ask me to the Enchantment Under The Sea Dance on Saturday.",
	"Uh, you mean nobody's asked you? No, not yet. What about George?",
	"George McFly? Oh, he's kinda cute and all, but, well, I think a man should be strong, so he could stand up for himself, and protect the woman he loves. Don't you? Yeah.",
	...
	"8:55, where are you gonna be. I'm gonna be at the dance. Right, and where am I gonna be? You're gonna be in the car with her.",
	...
	"No, no, George, look, it's just an act, right? Okay, so 9:00 you're strolling through the parking lot, you see us struggling in the car, you walk up, you open the door and you say, your line, George.",
	"Oh, uh, hey you, get your damn hands off her. Do you really think I oughta swear?",
	"Yes, definitely, god-dammit George, swear. Okay, so now, you come up, you punch me in the stomach, I'm out for the count, right? And you and Lorraine live happily ever after.",
	...
	"Are you sure about this storm? When could weathermen predict the weather, let alone the future.",
	...
	"What you got under here? Oh no, don't touch that. That's some new specialized weather sensing equipment.",
	"You got a permit for that? Of course I do. Just a second, let's see if I could find it.",
	"Do you mind if we park for a while?",
	"That's a great idea. I'd love to park. Huh?",
	"Well, Marty, I'm almost eighteen-years-old, it's not like I've never parked before. What?",
	...
	"Yeah well, you shouldn't drink. Why not? Because, you might regret it later in life.",
	...
	"Oh, you mean how you're supposed to act on a first date. Ah well, sort of. I think I know exactly what you mean. You do?",
	"You know what I do in those situations? What?",
	...
	"Let's put him in there. Yeah. That's for messing up my hair.",
	...
	"C'mon, open up, let me out of here, Yo. Lorenzo, where're you keys?",
	"The keys are in the trunk. Say that again. I said the keys are in here.",
	...
	"Give me a hand, Lorenzo. Ow, dammit, man, I sliced my hand. Who's are these? Thanks, thanks a lot.",
	"You're gonna break his arm. Biff, leave him alone. Let him go. Let him go.",
	"Are you okay?",
	"Who is that guy. That's George McFly.",
	...
	"George, aren't you gonna kiss me? I, I don't know. Scram, McFly.",
	"Hey boy, are you alright? I can't play.",
	"George. George. George. Excuse me.",
	"Yeah man, that was good. Let's do another one. Uh, well, I gotta go. C'mon man, let's do something that really cooks.",
	...
	"Lorraine. Marty, that was very interesting music. Uh, yeah.",
	"I hope you don't mind but George asked if he could take me home.",
	"Great good, good, Lorraine, I had a feeling about you two. I have a feeling too.",
	...
	"Right, George. Well, good luck you guys. Oh, one other thing, if you guys ever have kids and one of them when he's eight years old, accidentally sets fire to the living room rug, be easy on him.",
	...
	"He laid out Biff in one punch. I never knew he had it in him. He never stood up to Biff in his life. Never?. No, why, what's the matter?",
	...
	"Dammit, Doc, why did you have to tear up that letter? If only I had more time. Wait a minute, I got all the time I want I got a time machine, I'll just go back and warn him. 10 minutes oughta do it. Time-circuits on, flux-capacitor fluxing, engine running, alright. No, no no no no, c'mon c'mon. C'mon c'mon, here we go, this time. Please, please, c'mon.",
	"Doc.",
	"Crazy drunk drivers.",
	"Wow, ah Red, you look great. Everything looks great. 1:24, I still got time. Oh my god. No, no not again, c'mon, c'mon. Hey. Libyans.",
	"No, bastards.",
	"Doc, Doc. Oh, no. You're alive. Bullet proof vest, how did you know, I never got a chance to tell you. About all that talk about screwing up future events, the space time continuum.",
	...
	"Why thank you, Marty. George. Good morning, sleepyhead, Good morning, Dave, Lynda",
	"Good morning, Mom.",
	...
	"That Biff, what a character. Always trying to get away with something. Been on top of Biff ever since high school. Although, if it wasn't for him-",
