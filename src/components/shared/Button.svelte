<script>
  ...
  $: btnStrokeColor = strokeColorMap[type ??  "primary"];
</script>
...
<style>
  ...
  svg:active use[filter="url(#danger-hover)"],
  svg:active use[filter="url(#pri-hover)"],
  svg:active use[filter="url(#pri-shadow)"] {
    display: none;
  }
            ...
            <g id="b" transform="translate(-420.000000, -548.000000)">
                <g id="c" transform="translate(371.000000, 343.000000)">
                    <g id="g-btn" transform="translate(55.000000, 211.000000)">
                        <use fill="black" fill-opacity="1" filter="{type !== 'danger' ? "url(#pri-shadow)" :"url(#danger-shadow)"}" xlink:href="#path-1"></use>
                        <use fill="black" fill-opacity="1" filter="{type !== 'danger' ? "url(#pri-hover)" :"url(#danger-hover)"}" xlink:href="#path-1"></use>
